#!/usr/bin/env python3
"""
Test Script: Horizontal Scaling - Scale DOWN
...
- LLM recommends reducing replicas to save resources
...
# Target replica count (should be LESS than current for scale down)
TARGET_REPLICAS = 2
...
def main():
    print("\n" + "="*60)
    print("  HORIZONTAL SCALING TEST - SCALE DOWN")
